  ...
  blocks: [
    {
      ...
      duration: 10,
      notes:
        "Focus on crisp passes, no ball hitting the floor. Full court passing drill to get heart rates up.",
    },
    {
      time_slot: "0:10 - 0:15",
      ...
      duration: 5,
      notes:
        "Baseline to baseline lunges, high knees, butt kicks. Focus on proper form.",
    },
    {
      time_slot: "0:15 - 0:25",
      ...
      duration: 10,
      notes:
        "Defensive slides lane-to-lane full court. Focus on turning hips and maintaining low defensive stance.",
    },
    {
      time_slot: "0:25 - 0:40",
      ...
      duration: 15,
      notes:
        "4v4 half court. Focus on help-side positioning and defensive rotation. Emphasize 'jumping to the ball' on every pass.",
    },
    {
      time_slot: "0:40 - 0:50",
      ...
      duration: 10,
      notes:
        "Fast break drill. Offense attacks 3v2, defense rebounds and goes 2v1 other way. Focus on transition defense positioning.",
    },
    {
      time_slot: "0:50 - 1:05",
      ...
      duration: 15,
      notes:
        "Continuous full court layup drill. High intensity conditioning. Work on transition defense and communication.",
    },
    {
      time_slot: "1:05 - 1:25",
      ...
      duration: 20,
      notes:
        "Controlled 5v5 half court with specific constraints. Focus on transition defense principles in live play.",
    },
    {
      time_slot: "1:25 - 1:30",
...
export function generateMockPracticePlan(prompt: string): PracticePlan {
  ...
  const adjustedBlocks = blocks.map((block) => {
    ...
    const timeSlot = `${startMinutes}:${startSeconds
      .toString()
